                      ...
                      <div className='row'>
                        <div className='col-md-8 pr-4'>
                          <div>
                            <h6 className='py-2 pl-2'>You have got {products?.length} Item(s) for {products?.reduce((a, b) => a + b?.qty * b.price?.toString(), 0)}$</h6>
                            {
                              products?.map(prod => {
                                return (
                                  <div className='row border mb-4' style={{ padding: '10px', marginLeft: '10px', marginRight: '10px', marginBottom: '10px' }}>
                                    ...
                                    <div className=''>
                                      <button className='border border-bottom w-100 mt-2' style={{ border: 'none', height: '40px', fontWeight: 'bolder', color: '#696b79' }} onClick={() => removeHandler(prod.productId)}>Remove</button>
                                    </div>
                                  </div>
                                )
                              })
                        ...
                        <div className='col-md-4 mt-4'>
                          ...
                          <div className='w-100 mt-4'>
                            <button onClick={() => isAuthenticated() && moveToAddress()} className='btn my-2 w-100'>Place Order</button>
                          </div>
                        </div>
                      </div>
                    </>
